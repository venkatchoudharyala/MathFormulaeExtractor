...
Prompt = "From this Given Image, please extract Mathematical formulae one by one (Don't extract any textual matter) and convert them into LaTeX code (you should not generate any explnataions or tags to those formulae). Remember just generate the Math Formulae in LaTeX code!!"
