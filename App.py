...
Prompt = "From this Given Image, please extract Mathematical formulae one by one (Don't extract any textual matter) and convert them into LaTeX code (you should not generate any extra content other than formulae). Remember just generate the Math Formulae in LaTeX code, dont even include title tag for ur reponse!!"
